#!/bin/bash
export UUID=${UUID:-'a3fb4d94-fe95-4906-897a-877759dcaa1c'}
...
export ARGO_DOMAIN=${ARGO_DOMAIN:-'pella.w0318.netlib.re'}
export ARGO_AUTH=${ARGO_AUTH:-'eyJhIjoiODVhY2NkZmY1NDhlNTI2ZjFkM2UwYWVhNDFjMWU0NTIiLCJ0IjoiYWM2MTMzNTYtMjFlYy00YzZkLThjZDAtMWE4Njg3Mzc1NGNhIiwicyI6Ill6ZGlNVGcyTW1JdE5HUXlNeTAwWTJJMkxXSmtORFl0TkdaaFpXSTNabU5qTkRVeCJ9'}
